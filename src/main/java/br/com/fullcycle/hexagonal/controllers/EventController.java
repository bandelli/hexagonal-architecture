...
import br.com.fullcycle.hexagonal.application.usescases.CreateEventUseCase;
import br.com.fullcycle.hexagonal.application.usescases.SubscribeCustomerToEventUseCase;
    ...
    public ResponseEntity<?> create(@RequestBody EventDTO dto) {
        try {
            ...
            final var output = useCase.
                    execute(new CreateEventUseCase.Input(dto.getDate(), dto.getName(), partnerId, dto.getTotalSpots()));
